...
int main( int argc, char *argv[] )
{
	...
	int OPTSCALE =TOUT+1; double optimizerScale[5]={1.0, 1.0/128.0,1.0/128.0, 1000.0,1000.0}; Vparams.push_back("oprimizers scales theta");
	Vparams.push_back("oprimizers scales x-Xc");
	Vparams.push_back("oprimizers scales y-Yc");
	Vparams.push_back("oprimizers scales tx");
	Vparams.push_back("oprimizers scales ty");
