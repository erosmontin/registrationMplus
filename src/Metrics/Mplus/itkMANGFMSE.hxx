...
::GetMAValue(const ParametersType & parameters) const
 {
	return static_cast<MeasureType> ( m_MA->GetValue(parameters) * this->m_Mu);
...
typename MANGFMSE<TFixedImage, TMovingImage>::MeasureType
MANGFMSE<TFixedImage, TMovingImage>
::GetMSEValue(const ParametersType & parameters) const
{
...
::GetDerivative(const ParametersType & parameters,DerivativeType & derivative) const
 {
	...
	{derivative[p]= a[p]*this->m_MuDerivative + this->m_LambdaDerivative*b[p] + this->m_NuDerivative*b[p];}
