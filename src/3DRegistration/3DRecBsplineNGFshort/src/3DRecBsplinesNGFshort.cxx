...
#include "../../../Metrics/NGF/NGFImageMetric/NGFImageToImageMetric/Code/itkNormalizedGradientFieldImageToImageMetric.h"
...
int main( int argc, char *argv[] )
{
	...
	int NGFEV=NT+1; int NGFEvaluator=0;Vparams.push_back("NGF Evaluator (0 scalar,1cross,2scdelta,3Delta,4Delta2)");	readParametersFromStdin(&NGFEvaluator,NGFEV,argv,argc,no);
  ...
  typedef itk::NormalizedGradientFieldImageToImageMetric< FixedImageType, FixedImageType >  MetricType;
  ...
  typedef MetricType::FixedNGFType  FixedNGFType;
	...
	FixedImageType::ConstPointer fixedImage = fixedImageReader->GetOutput();
	 ...
	 if (NGFEvaluator==0) {metric->SetEvaluator(new itk::NGFScalarKernel<MovingNGFType, FixedNGFType>());
			...
			metric->ReinitializeSeed(std::rand() % 3000 + 190085);
