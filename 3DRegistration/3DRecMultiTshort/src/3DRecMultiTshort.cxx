...
//
//
//for (int TP =0; TP<transform->GetNumberOfParameters();TP++){
//		std::cout<<finalParameters.get(TP)<<std::endl;
//	};



//
//InternalImageType::PointType C;
//C.Fill(0.0);
//
//TransformType::OutputPointType trackerPointNewPosition;
//  trackerPointNewPosition = finalTransform->TransformPoint(C);
//  std::cout<<"trackerPointNewPosition: " <<trackerPointNewPosition<<std::endl;
