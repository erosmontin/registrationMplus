...
int nidivisor =1;
#include "../../../include/commandVERSOR.h"
...
int main( int argc, char *argv[] )
{
	...
	int OPTSCALE =TOUT+1; double optimizerScale[Dimension+Dimension]={1.0, 1.0,1.0, 1e-3,1e-3,1e-3};
...
initialParameters=transform->GetParameters();
	...
	std::cout<<"initial: "<<registration->GetInitialTransformParameters()<<'\n';
