  ...
  //http://www.itk.org/Doxygen/html/WikiExamples_2ImageProcessing_2ScaleTransform_8cxx-example.html#_a2
...
int main( int argc, char *argv[] )
{
	...
	int OPTSCALE =TOUT+1; double optimizerScale[Dimension]={1.0, 1.0,1.0}; Vparams.push_back("oprimizers scales theta");
	

	for (int a=0;a<Dimension;a++)
		{
	Vparams.push_back("oprimizers scales S" + tostr(a));
	...
	typedef itk::CenteredTransformInitializer<
            TransformType, InternalImageType,
